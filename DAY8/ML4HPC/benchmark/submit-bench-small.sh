...
python "/leonardo/pub/userinternal/mcelori1/MagureleRAPIDS/rapids_venv/lib/python3.12/site-packages/dask_cuda/benchmarks/local_cudf_merge.py" --scheduler-address "$SCHED_ADDR" --interface "ib0" --protocol "ucx" -c 50_000_000  --frac-match 0.3  --markdown  --all-to-all --threads-per-worker 8 -d 0,1,2,3,4,5,6,7  --runs 10 > $JOB_OUTPUT_DIR/raw_data.txt
